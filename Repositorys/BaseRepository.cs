...
namespace Repositorys
{
    public abstract class BaseRepository<TModel> where TModel : class
    {
        ...
        /// 新增 TModel 資料表
        /// </summary>
        public async Task<ApiResult<TModel>> Insert(TModel param)
        {
        ...
        /// 整筆修改 TModel 資料表
        /// </summary>
        public async Task<ApiResult<TModel>> Update(TModel param)
        {
        ...
        /// 部分修改 TModel 資料表
        /// </summary>
        public async Task<ApiResult<TModel>> Patch(TModel param, HashSet<string> updateCol)
        {
