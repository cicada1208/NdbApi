...
{
    public class FocusRecordRepository : BaseRepository<FocusRecord>
    {
        /// <summary>
        /// 查詢護理焦點
        /// <para>1: 依參數自動組建</para>
            ...
            string sql = @"
                    ...
                    from (
                        ...
                        from (
                            ...
                            from ni_FocusRecord as A11 (index ni_FocusRecord_2)
                            where A11.ptEncounterId=@ptEncounterId and A11.isActive=1
                        ) As A1
                        group by A1.focusItemId, A1.focusName
                    ) As frecg
                    inner join ni_FocusRecord as frec (index ni_FocusRecord_2)
            ...
            switch (option)
            {
                ...
                case 2:
                    ...
                    and frec.focusStatus not in (
                        ...
                        left join ni_TermLib as termlib (index ni_TermLib_1)
