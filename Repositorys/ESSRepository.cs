...
{
    public class ESSRepository : BaseRepository<ESS>
    {
        /// <summary>
        /// 查詢情緒壓力篩檢表
        /// <para>1: 依參數自動組建</para>
            ...
            switch (option)
            {
                case 2:
                    ...
                    queryList.ForEach(e =>
                    {
                        ...
                        {
                            ch_csers = DB.Ch_cserRepository.GetCh_cser(new Ch_cser
                            {
                        ...
                        { // 有回覆日期即代表收案
                            e.Info = string.Join(System.Environment.NewLine, ch_csers.Select(c =>
                            {
