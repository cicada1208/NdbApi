...
namespace Lib
{
    public class DBUtil
    {
        ...
        {
            if (isUnicodeParam)
                Dapper.SqlMapper.AddTypeMap(typeof(string), System.Data.DbType.AnsiString); // System.Data.DbType.String 2022.11.17 測試
            else
        ...
        public IEnumerable<TModel> Query<TModel>(object entityParam = null,
            int? cmdTimeout = null, bool? isUnicodeParam = null,
            StrParam.TrimType trimType = StrParam.TrimType.TrimEnd, bool nullToEmpty = true, bool schemaOnly = false) =>
            QueryAsync<TModel>(entityParam, cmdTimeout, isUnicodeParam, trimType, nullToEmpty, schemaOnly).Result;
        ...
        /// <param name="entityParam">entity, 未必定義 TableAttribute</param>
        /// <param name="schemaOnly">true:僅表結構，預設false</param>
        public async Task<IEnumerable<TModel>> QueryAsync<TModel>(object entityParam = null,
            int? cmdTimeout = null, bool? isUnicodeParam = null,
            StrParam.TrimType trimType = StrParam.TrimType.TrimEnd, bool nullToEmpty = true, bool schemaOnly = false)
        {
            IDbConnection conn = null;
        ...
        /// <summary>
        /// Dapper Query：自訂sql 建立條件查詢
        /// </summary>
        /// <typeparam name="TModel">依此查詢 DBType、DBName，若 TModel 無定義則取自建構子定義</typeparam>
        /// <param name="entityParam">entity, 未必定義 TableAttribute</param>
        public IEnumerable<TModel> Query<TModel>(string sql, object entityParam = null,
            int? cmdTimeout = null, bool? isUnicodeParam = null,
            StrParam.TrimType trimType = StrParam.TrimType.TrimEnd, bool nullToEmpty = true) =>
            QueryAsync<TModel>(sql, entityParam, cmdTimeout, isUnicodeParam, trimType, nullToEmpty).Result;

        /// <summary>
        /// Dapper Query：自訂 sql 建立條件查詢
        /// </summary>
        /// <typeparam name="TModel">依此查詢 DBType、DBName，若 TModel 無定義則取自建構子定義</typeparam>
        /// <param name="entityParam">entity, 未必定義 TableAttribute</param>
        public async Task<IEnumerable<TModel>> QueryAsync<TModel>(string sql, object entityParam = null,
            int? cmdTimeout = null, bool? isUnicodeParam = null,
            StrParam.TrimType trimType = StrParam.TrimType.TrimEnd, bool nullToEmpty = true)
        {
            IDbConnection conn = null;
            ...
            try
            {
                ...
                if (isUnicodeParam == null) isUnicodeParam = IsUnicodeParamDefault;
                SetUnicodeParam((bool)isUnicodeParam);
                result = await conn.QueryAsync<TModel>(sql, entityParam as object, commandTimeout: cmdTimeout);
                if (trimType != StrParam.TrimType.None || nullToEmpty)
                    result = result.ToList().StrProcess(trimType, nullToEmpty);
            }
            catch (Exception ex)
        ...
        /// Dapper Query：整合查詢
        /// </summary>
        public IEnumerable<TModel> QueryIntgr<TModel>(string sql = "", object entityParam = null,
            int? cmdTimeout = null, bool? isUnicodeParam = null,
            StrParam.TrimType trimType = StrParam.TrimType.TrimEnd, bool nullToEmpty = true, bool schemaOnly = false)
        {
            return sql == string.Empty ?
                Query<TModel>(entityParam, cmdTimeout, isUnicodeParam, trimType, nullToEmpty, schemaOnly) :
                Query<TModel>(sql, entityParam, cmdTimeout, isUnicodeParam, trimType, nullToEmpty);
        }

        /// <summary>
        /// Dapper Query：整合查詢
        /// </summary>
        public Task<IEnumerable<TModel>> QueryIntgrAsync<TModel>(string sql = "", object entityParam = null,
            int? cmdTimeout = null, bool? isUnicodeParam = null,
            StrParam.TrimType trimType = StrParam.TrimType.TrimEnd, bool nullToEmpty = true, bool schemaOnly = false)
        {
            return sql == string.Empty ?
                QueryAsync<TModel>(entityParam, cmdTimeout, isUnicodeParam, trimType, nullToEmpty, schemaOnly) :
                QueryAsync<TModel>(sql, entityParam, cmdTimeout, isUnicodeParam, trimType, nullToEmpty);
        }
        ...
        public DataTable Query(string sql, object entityParam = null, DataTable dtData = null, int? cmdTimeout = null, bool? isUnicodeParam = null,
            StrParam.TrimType trimType = StrParam.TrimType.TrimEnd, bool nullToEmpty = true) =>
            QueryAsync(sql, entityParam, dtData, cmdTimeout, isUnicodeParam, trimType, nullToEmpty).Result;
        ...
        /// <param name="dtData">資料</param>
        /// <returns>table schema</returns>
        public async Task<DataTable> QueryAsync(string sql, object entityParam = null, DataTable dtData = null, int? cmdTimeout = null, bool? isUnicodeParam = null,
            StrParam.TrimType trimType = StrParam.TrimType.TrimEnd, bool nullToEmpty = true)
        {
            IDbConnection conn = null;
        ...
        /// <typeparam name="TModel">依此查詢 DBType、DBName、TableName，具有定義 TableAttribute</typeparam>
        /// <param name="entityParam">entity, 未必定義 TableAttribute</param>
        public int Insert<TModel>(object entityParam, int? cmdTimeout = null, bool? isUnicodeParam = null) =>
            InsertAsync<TModel>(entityParam, cmdTimeout, isUnicodeParam).Result;
        ...
        /// <typeparam name="TModel">依此查詢 DBType、DBName、TableName，具有定義 TableAttribute</typeparam>
        /// <param name="entityParam">entity, 未必定義 TableAttribute</param>
        public async Task<int> InsertAsync<TModel>(object entityParam, int? cmdTimeout = null, bool? isUnicodeParam = null)
        {
            IDbConnection conn = null;
            SqlCmdUtil sqlCmd = null;
            int rowsAffected = 0;
        ...
        /// <summary>
        /// Dapper Execute Update：自動建立修改
        /// </summary>
        /// <typeparam name="TModel">依此查詢 DBType、DBName、TableName，具有定義 TableAttribute</typeparam>
        /// <param name="entityParam">entity, 未必定義 TableAttribute</param>
        public int Update<TModel>(object entityParam, int? cmdTimeout = null, bool? isUnicodeParam = null) =>
            UpdateAsync<TModel>(entityParam, cmdTimeout, isUnicodeParam).Result;
        ...
        /// <param name="entityParam">entity, 未必定義 TableAttribute</param>
        public async Task<int> UpdateAsync<TModel>(object entityParam, int? cmdTimeout = null, bool? isUnicodeParam = null)
        {
            IDbConnection conn = null;
            SqlCmdUtil sqlCmd = null;
            int rowsAffected = 0;
        ...
        /// <summary>
        /// Dapper Execute Patch：自動建立修改
        /// </summary>
        /// <typeparam name="TModel">依此查詢 DBType、DBName、TableName，具有定義 TableAttribute</typeparam>
        /// <param name="entityParam">entity, 未必定義 TableAttribute</param>
        /// <param name="updateCol">update 欄位</param>
        public int Patch<TModel>(object entityParam, HashSet<string> updateCol,
            int? cmdTimeout = null, bool? isUnicodeParam = null) =>
            PatchAsync<TModel>(entityParam, updateCol, cmdTimeout, isUnicodeParam).Result;
        ...
        /// <param name="entityParam">entity, 未必定義 TableAttribute</param>
        /// <param name="updateCol">update 欄位</param>
        public async Task<int> PatchAsync<TModel>(object entityParam, HashSet<string> updateCol,
            int? cmdTimeout = null, bool? isUnicodeParam = null)
        {
            IDbConnection conn = null;
            SqlCmdUtil sqlCmd = null;
        ...
        /// </summary>
        /// <param name="entityParam">entity, 未必定義 TableAttribute</param>
        public int Execute(string sql, object entityParam = null, int? cmdTimeout = null, bool? isUnicodeParam = null) =>
            ExecuteAsync(sql, entityParam, cmdTimeout, isUnicodeParam).Result;

        /// <summary>
        /// Dapper Execute Insert、Update、Delete
        /// </summary>
        /// <param name="entityParam">entity, 未必定義 TableAttribute</param>
        public async Task<int> ExecuteAsync(string sql, object entityParam = null, int? cmdTimeout = null, bool? isUnicodeParam = null)
        {
            IDbConnection conn = null;
            int rowsAffected = 0;
            ...
            try
            {
                ...
                if (isUnicodeParam == null) isUnicodeParam = IsUnicodeParamDefault;
                SetUnicodeParam((bool)isUnicodeParam);
                rowsAffected = await conn.ExecuteAsync(sql, entityParam as object, commandTimeout: cmdTimeout);
            }
            catch (Exception ex)
            {
                throw new Exception(LogSql(sql, entityParam), ex);
        ...
        public int Execute(IEnumerable<SqlCmdUtil> sqlCmds, int? cmdTimeout = null, bool? isUnicodeParam = null, bool isTransaction = true) =>
            ExecuteAsync(sqlCmds, cmdTimeout, isUnicodeParam).Result;

        public async Task<int> ExecuteAsync(IEnumerable<SqlCmdUtil> sqlCmds, int? cmdTimeout = null, bool? isUnicodeParam = null, bool isTransaction = true)
        {
            IDbConnection conn = null;
            int rowsAffected = 0;
