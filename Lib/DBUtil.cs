...
namespace Lib
{
    public class DBUtil
    {
        ...
        public int Patch<TModel>(object param, HashSet<string> updateCol,
            int? cmdTimeout = null) =>
        ...
        /// <param name="param">未必定義 TableAttribute</param>
        /// <param name="updateCol">update 欄位</param>
        public async Task<int> PatchAsync<TModel>(object param, HashSet<string> updateCol,
            int? cmdTimeout = null)
        {
            IDbConnection conn = null;
            SqlCmdUtil sqlCmd = null;
        ...
        public async Task<int> ExecuteAsync(string sql, object param = null, int? cmdTimeout = null)
        {
            ...
            {
                conn = this.CreateConn();
                rowsAffected = await conn.ExecuteAsync(sql, param as object, commandTimeout: cmdTimeout);
            }
            catch (Exception ex)
            {
                throw new Exception(LogSql(sql, param), ex);
