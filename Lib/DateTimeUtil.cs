...
namespace Lib
{
    public class DateTimeUtil
    {
        ...
        public string DateTimeDiff(string str1, string str2,
        ...
        public string DateTimeDiff(DateTime dt1, DateTime dt2)
        {
            string result = string.Empty;
            try
            {
        ...
        /// </summary>
        /// <remarks>str2 >= str1</remarks>
        public TimeSpan DateTimeDiffTS(string str1, string str2,
            string str1Format = "yyyy/MM/dd HH:mm:ss", string str2Format = "yyyy/MM/dd HH:mm:ss")
        {
        ...
        /// </summary>
        /// <remarks>dt2 >= dt1</remarks>
        public TimeSpan DateTimeDiffTS(DateTime dt1, DateTime dt2)
        {
            TimeSpan ts = default;
            try
            {
        ...
        /// <param name="outFormat">輸出格式</param>
        /// <returns>西元年或民國年</returns>
        public string ROCNextDay(string inDate, int nDays = 1, bool toAD = false,
        ...
        /// 取得星期幾
        /// </summary>
        public string DayOfWeek(string dt, bool shortest = true)
        {
            string result = string.Empty;
