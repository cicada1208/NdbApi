...
namespace Models
{
    [Lib.Attributes.Table(DBParam.DBType.SYBASE, DBParam.DBName.NIS, "ni_FallASE_Adult")]
    public class FallASE_Adult
    {
        [Key]
        ...
        public string ASEItem1C { get; set; }

        public string ASEItem2C { get; set; }

        public string ASEItem3C { get; set; }

        public string ASEItem4C { get; set; }

        public string ASEItem5C { get; set; }

        public string ASEItem6C { get; set; }

        public string ASEItem7C { get; set; }

        public string ASEItem8C { get; set; }

        public string ASEItem9C { get; set; }

        public string ASEItem10C { get; set; }

        public string ASEItem11C { get; set; }

        public string ASEItem12C { get; set; }

        public string ASEItem13C { get; set; }

        public string ASEItem14C { get; set; }

        public string ASEItem15C { get; set; }
